...
const Freelancer = () => {
  ...
  const fetchUserData = async(id) =>{
      axios.get(`http://localhost:6002/fetch-freelancer/${id}`).then(
        (response)=>{
  ...
  const updateUserData = async() =>{
    axios.post(`http://localhost:6002/update-freelancer`, {freelancerId, updateSkills: updateSkills, description: updateDescription}).then(
        (response)=>{
          fetchUserData();
  ...
  const fetchApplications = async() =>{
    await axios.get("http://localhost:6002/fetch-applications").then(
      (response)=>{
